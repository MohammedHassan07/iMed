/*
  ...
  - Added the required column `purchaseDate` to the `ReturnedPurchasedItem` table without a default value. This is not possible if the table is not empty.
