/*
  ...
  - Added the required column `parentPurchaseId` to the `ReturnedPurchasedItem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ReturnedPurchasedItem" ("batchNumber", "createdAt", "expiryDate", "id", "medicineId", "packageQuantity", "purchaseId", "purchasePrice", "quantity", "reason", "remainingMedicines", "returnQty", "sellingPrice", "sellingPricePerMedicine", "totalMedicines", "updatedAt") SELECT "batchNumber", "createdAt", "expiryDate", "id", "medicineId", "packageQuantity", "purchaseId", "purchasePrice", "quantity", "reason", "remainingMedicines", "returnQty", "sellingPrice", "sellingPricePerMedicine", "totalMedicines", "updatedAt" FROM "ReturnedPurchasedItem";
