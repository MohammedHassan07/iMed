/*
  ...
  - Added the required column `packageQuantity` to the `PurchaseItem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_PurchaseItem" ("batchNumber", "createdAt", "expiryDate", "id", "isSold", "medicineId", "profit", "purchaseId", "purchasePrice", "quantity", "remainingMedicines", "scheme", "sellingPrice", "sellingPricePerMedicine", "tax", "total", "totalMedicines", "updatedAt") SELECT "batchNumber", "createdAt", "expiryDate", "id", "isSold", "medicineId", "profit", "purchaseId", "purchasePrice", "quantity", "remainingMedicines", "scheme", "sellingPrice", "sellingPricePerMedicine", "tax", "total", "totalMedicines", "updatedAt" FROM "PurchaseItem";
