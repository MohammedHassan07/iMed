/*
  ...
  - You are about to alter the column `boxNumber` on the `medicine` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
