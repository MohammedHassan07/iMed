/*
  ...
  - Added the required column `sellingPricePerMedicine` to the `PurchaseItem` table without a default value. This is not possible if the table is not empty.
