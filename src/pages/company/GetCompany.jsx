...
const GetCompany = () => {
    ...
    const fields = [
        ...
        { name: "mfgCode", label: "MFG Code", type: "text", placeholder: "Enter MFG" },

    ]

    const fetchItems = async () => {
        try {
            const response = await window.electronAPI.getCompany({
                page: currentPage,
                limit: itemsPerPage,
                search: search.trim(),
            });
                ...
                <table className="min-w-full border border-gray-300 text-sm table-fixed">
                    <thead>
                        <tr className="bg-gray-100 text-left text-gray-700">
                            ...
                            <th className="px-4 py-3 border-b w-[25%]">MFG Code</th>
                    ...
                    <tbody>
                        {suppliers.map((supplier, index) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-3 truncate">{supplier.mfgCode}</td>
